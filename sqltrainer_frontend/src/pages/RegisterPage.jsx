  ...
  return (
    <div className="flex justify-center pt-16">
      <div className="w-full max-w-sm">
        <h1 className="text-2xl font-bold text-center mb-6 dark:text-gray-100">Регистрация</h1>
        ...
        <p className="text-center text-sm text-gray-500 dark:text-gray-400 mt-4">
          Уже есть аккаунт?{' '}
          <Link to="/login" className="text-indigo-600 dark:text-indigo-400 hover:underline">Войти</Link>
        </p>
      </div>
    </div>
  )
